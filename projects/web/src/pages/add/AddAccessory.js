...
const AddAccessory = () => {
  ...
  const handleSave = (e) => {
    ...
    const isValid = validateAddAccessory({name, img, type, recipes: formattedRecipes, usedIn, obtain, categories});
  ...
  return <div className="form-fields">
    ...
    <RecipesInput header="Recipes" recipes={recipes} setRecipes={setRecipes}/>
